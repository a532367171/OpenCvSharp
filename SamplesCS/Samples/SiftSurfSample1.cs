...
namespace SamplesCS
{
    ...
    /// </summary>
    class SiftSurfSample1 : ISample
    {
        public void Run()
        {
            var src1 = new Mat(FilePath.Image.Match3, ImreadModes.Color);
            var src2 = new Mat(FilePath.Image.Match4, ImreadModes.Color);
        ...
        private void MatchBySift(Mat src1, Mat src2)
        {
            ...
            // Detect the keypoints and generate their descriptors using SIFT 检测要点,并生成了使用筛选描述符
            ...
            // Match descriptor vectors 描述符匹配向量
